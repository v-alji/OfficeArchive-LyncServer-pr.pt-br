...
## <a name="assigning-a-per-user-mobility-policy-by-using-windows-powershell-cmdlets"></a>Atribuir uma política de mobilidade Per-User usando cmdlets do Windows PowerShell
