...
Mover usuários para a Unificação de mensagens do Exchange consiste nas seguintes tarefas:
  ...
  - Habilite os usuários para atendimento de chamada de Unificação de mensagens do Exchange e Outlook Voice Access. Esta tarefa é executada no servidor de Unificação de mensagens do Exchange. Para obter detalhes, consulte a biblioteca do TechNet do Exchange Server 2010 em [https://go.microsoft.com/fwlink/p/?linkID=139372](https://go.microsoft.com/fwlink/p/?linkid=139372) .
