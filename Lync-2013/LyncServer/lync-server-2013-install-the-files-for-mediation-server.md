...
1.  Na mídia de instalação, clique com o botão direito do mouse em \<installation media\> **\\ Configurar \\ AMD64 \\Setup.exe** e, em seguida, clique em **Executar como administrador**.
