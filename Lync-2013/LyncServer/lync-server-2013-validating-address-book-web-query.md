...
A saída anterior informa que o teste falhou porque o usuário de destino não foi encontrado. Você pode determinar se um endereço SIP válido foi ou não passado para Test-CsAddressBookWebQuery executando um comando semelhante ao seguinte:
...
Veja a seguir alguns motivos comuns para que Test-CsAddressBookWebQuery possam falhar:
