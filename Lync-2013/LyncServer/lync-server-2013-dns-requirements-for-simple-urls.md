...
Ao usar esse método, você pode configurar cada endereço GeoDNS para usar um método Round Robin para distribuir solicitações para os dois pools ou para se conectar principalmente a um pool (como o pool localizado geograficamente) e usar o outro pool somente em caso de falha de conectividade.
