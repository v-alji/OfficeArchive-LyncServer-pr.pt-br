...
<td><p>Procedimentos de backup do SQL Server ou Export-CsPersistentChatData. Export-CsPersistentChatData exporta dados de chat persistentes como um arquivo.</p></td>
</tr>
<tr class="odd">
