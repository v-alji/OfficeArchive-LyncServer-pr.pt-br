...
## <a name="support-for-read-only-domain-controllers"></a>Suporte para controladores de domínio do Read-Only
...
O Lync Server não dá suporte a domínios com rótulo único. Por exemplo, uma floresta com um domínio raiz chamado **contoso. local** tem suporte, mas não há suporte para um domínio raiz chamado **local** . Para obter detalhes, consulte o artigo 300684 da base de dados de conhecimento Microsoft, "informações sobre como configurar o Windows para domínios com nomes DNS de rótulo único" em [https://go.microsoft.com/fwlink/p/?linkId=143752](https://go.microsoft.com/fwlink/p/?linkid=143752) .
...
## <a name="locked-down-ad-ds-environments"></a>Ambientes AD DS bloqueados
