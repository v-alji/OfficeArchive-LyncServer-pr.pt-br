...
A exibição SessionDetails armazena informações sobre sessões ponto a ponto, que podem ser uma chamada telefônica VoIP-VoIP, uma sessão de mensagens instantâneas de dois participantes ou outro tipo de sessão. Este modo de exibição foi apresentado no Microsoft Lync Server 2013.
