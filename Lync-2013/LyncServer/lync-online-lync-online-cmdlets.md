...
Para obter informações sobre como configurar seu computador para usar o Windows PowerShell para gerenciar com o Lync Online, consulte o tópico da ajuda [usando o Windows PowerShell para gerenciar o Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).
