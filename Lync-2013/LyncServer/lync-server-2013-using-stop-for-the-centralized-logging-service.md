...
2.  Consulte o serviço de log centralizado para descobrir quais cenários estão sendo executados digitando o seguinte:
    ...
    ![Console do Windows PowerShell após chamar show-CsCl](images/JJ687964.eb190c32-529c-4277-a731-52c47d22d8fa(OCS.15).jpg "Console do Windows PowerShell após a chamada Show-CsCl")
