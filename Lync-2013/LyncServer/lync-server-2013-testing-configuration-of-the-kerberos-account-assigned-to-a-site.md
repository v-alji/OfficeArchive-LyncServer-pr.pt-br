...
Para obter mais informações, consulte a documentação da ajuda para o cmdlet [Test-CsKerberosAccountAssignment](https://technet.microsoft.com/library/Gg425938(v=OCS.15)) .
...
Veja a seguir alguns motivos comuns para que Test-CsKerberosAccountAssignment possam falhar:
