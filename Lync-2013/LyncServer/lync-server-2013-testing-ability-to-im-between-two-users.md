...
Quando o parâmetro Verbose estiver incluído, Test-CsIM retornará uma conta passo a passo de cada ação que tentou quando verificou a capacidade dos dois usuários de teste participarem de uma sessão de mensagem instantânea. Por exemplo, veja a seguir uma saída de exemplo que ocorre quando um conjunto incorreto de credenciais de usuário (nesse caso, uma senha incorreta) é fornecido para Test-CsIM:
...
Veja a seguir alguns motivos comuns para que Test-CsIM possam falhar:
