...
Os tópicos desta seção fornecem procedimentos passo a passo para tarefas que você pode executar usando o grupo **mensagens instantâneas e presença** no painel de controle do Lync Server 2013.
...
## <a name="in-this-section"></a>Nesta seção
  ...
  - [Como atribuir políticas de presença por usuário no Lync Server 2013](lync-server-2013-assigning-per-user-presence-policies.md)
