...
Use a ferramenta kit de recursos do SEFAUtil para habilitar o recurso de recebimento de chamadas em grupo para usuários. Os usuários devem receber um número de grupo com o tipo GroupPickup na tabela órbita do estacionamento de chamada para que a retirada de chamadas em grupo seja habilitada. Você atribui um número de grupo de encaminhamento de chamada e habilita o recebimento de chamadas de grupo ao mesmo tempo usando o parâmetro/enablegrouppickup quando você executa o SEFAUtil.exe.
