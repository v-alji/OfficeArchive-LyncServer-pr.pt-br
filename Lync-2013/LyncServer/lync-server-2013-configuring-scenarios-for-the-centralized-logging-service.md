...
2.  No Windows PowerShell, digite:
    ...
    > [!TIP]  
    > O carregamento bem-sucedido do módulo o devolve para o prompt de comando do Windows PowerShell. Para confirmar se o módulo está carregado e se Edit-CsClsScenario está disponível, digite <CODE>Get-Help Edit-CsClsScenario</CODE> . Você deverá ver a sinopse básica da sintaxe de EditCsClsScenario.
...
3.  Para descarregar os módulos, digite:
    ...
    > [!TIP]  
    > O descarregamento bem-sucedido do módulo retorna para o prompt de comando do Windows PowerShell. Para confirmar se o módulo é descarregado, digite <CODE>Get-Help Edit-CsClsScenario</CODE> . O Windows PowerShell tentará localizar a ajuda para o cmdlet e falhar.
...
2.  Para adicionar um provedor ao cenário AlwaysOn, digite:
    ...
    \-LogLevel pode ser do tipo fatal, Error, Warning, info, Verbose, debug ou ALL. – Os sinalizadores podem ser qualquer um dos sinalizadores compatíveis com o provedor, como o \_ componente TF, TF \_ diag. –Flags também pode ter o valor ALL
