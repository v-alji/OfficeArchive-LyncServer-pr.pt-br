...
Se Test-CsMcxPushNotification tiver sucesso, o cmdlet retornará o resultado do resultado do teste:
...
Test-CsMcxPushNotification: solicitação de notificação por push foi rejeitada.
