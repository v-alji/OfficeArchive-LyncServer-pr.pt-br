...
## <a name="assigning-a-per-user-conferencing-policy-by-using-windows-powershell-cmdlets"></a>Atribuir uma política de conferência Per-User usando cmdlets do Windows PowerShell
...
Para obter mais informações, consulte o tópico da ajuda para o cmdlet [Grant-CsConferencingPolicy](https://technet.microsoft.com/library/gg425937\(v=ocs.15\)) .
