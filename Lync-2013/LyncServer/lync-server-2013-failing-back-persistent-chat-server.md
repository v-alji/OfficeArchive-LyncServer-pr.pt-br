...
1.  Desmarque todos os servidores da lista de servidores de chat persistentes usando o `Set-CsPersistentChatActiveServer` cmdlet do Shell de gerenciamento do Lync Server. Isso interrompe a conexão de todos os servidores de chat persistentes ao banco de dados do MGC e do banco de dados do mgccomp durante o failback.
...
3.  Faça backup do banco de dados mgc para que ele possa ser restaurado para o novo banco de dados primário:
    ...
    6.  *\<Optional\>* Em **Descrição**, digite uma descrição do conjunto de backup.
