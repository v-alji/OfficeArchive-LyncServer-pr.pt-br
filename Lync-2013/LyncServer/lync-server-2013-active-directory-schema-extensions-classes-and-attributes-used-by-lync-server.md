...
Esta seção de referência inclui as seguintes informações:
  ...
  - Alterações feitas em uma UO (unidade organizacional) do Active Directory pelo \_ cmdlet Grant CsSetupPermission.

  - Alterações feitas em uma UO do Active Directory pelo \_ cmdlet Grant CsOUPermission.
