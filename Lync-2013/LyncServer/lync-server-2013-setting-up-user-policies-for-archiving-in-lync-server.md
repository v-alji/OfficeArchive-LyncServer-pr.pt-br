...
Os usuários sempre são hospedados no Lync Server. Se a integração com o Microsoft Exchange estiver habilitada, os usuários cujas caixas de correio estiverem no Microsoft Exchange Server 2013 não precisarão ter suas políticas de arquivamento no Lync Server gerenciadas. Esses usuários com arquivamento serão gerenciados pelo Exchange In-Place em espera.
