...
Apresentado em [visão geral do serviço de log centralizado no Lync Server 2013](lync-server-2013-overview-of-the-centralized-logging-service.md), os principais elementos da definição de um provedor para uso em um cenário são:
  ...
  - **Níveis de registro em log**   OCSLogger forneceu a opção de escolher um número de níveis de detalhes para os dados coletados. Esse recurso é uma parte integral do serviço e cenários de registro centralizado e é definido pelo parâmetro de **tipo** . As seguintes opções estão disponíveis:
      ...
      - **Todas as**   Coleta mensagens de rastreamento do tipo fatal, erro, aviso e informações no log para o provedor definido.
    
      - **Fatal**   Coleta apenas as mensagens de rastreamento que indicam uma falha para o provedor definido.
    
      - **Erro ao**   Coleta apenas as mensagens de rastreamento que indicam um erro para o provedor definido, além de mensagens fatais.
      ...
      - **Info**  Coleta somente as mensagens de rastreamento que indicam uma mensagem informativa do provedor definido, bem como mensagens do tipo Warning, Error ou Fatal.
    
      - **Modo detalhado**   Coleta todas as mensagens de rastreamento do tipo fatal, erro, aviso e informações para o provedor definido.
  ...
  - **Marcas**   OCSLogger forneceu a opção de escolher sinalizadores para cada provedor que definia o tipo de informação que você pode recuperar dos arquivos de rastreamento. Você pode escolher os seguintes sinalizadores, com base no provedor:
      ...
      - **TF \_ Protocolo**   fornece mensagens de protocolo como SIP e mensagens de pacote de codec de comunidade combinadas.
    
      - **TF \_ O componente**   habilita o registro em log dos componentes especificados como parte dos provedores.
