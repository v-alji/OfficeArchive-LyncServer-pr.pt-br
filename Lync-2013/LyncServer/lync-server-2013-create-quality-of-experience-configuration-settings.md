...
> [!NOTE]  
> O cmdlet New-CsQoEConfiguration inclui opções adicionais não disponíveis no painel de controle do Lync Server. Para obter mais informações, consulte o tópico da ajuda <A href="https://docs.microsoft.com/powershell/module/skype/New-CsQoEConfiguration">New-CsQoEConfiguration</A> .
