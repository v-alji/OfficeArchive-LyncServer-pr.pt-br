...
O Lync Server 2013 contém vários cmdlets que iniciam comandos sintéticos para confirmar se uma função específica ou um recurso está funcionando corretamente. Test-CsAddressBookService confirma que um usuário definido pode se conectar e solicitar os arquivos locais do serviço Web de catálogo de endereços.
