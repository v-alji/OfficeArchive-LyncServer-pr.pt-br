...
Por exemplo, se você salvou os dados em um arquivo denominado C: \\ lista de chamadas em grupo de resposta a dados \\ \_ \_ \_ \_Report.csv, poderá usar o seguinte comando para retornar o número total de chamadas recebidas para cada fluxo de trabalho listado no relatório:
