...
Antes de começar a migração para o Lync Server 2013, recomendamos que você execute um backup completo do sistema e documente o sistema existente, incluindo um inventário de contas de usuário que são hospedadas em cada pool, para que você possa reverter para o Lync Server 2010 se for necessário. Há várias ferramentas e programas disponíveis para fazer o backup e a restauração de dados, configurações e sistemas.
