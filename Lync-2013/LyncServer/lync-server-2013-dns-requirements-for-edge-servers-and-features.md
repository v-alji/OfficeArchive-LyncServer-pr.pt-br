...
Servidores de borda do Lync Server 2013, pools de bordas e proxies invertidos têm requisitos específicos para registros DNS (sistema de nomes de domínio). No Lync Server 2013 quando IPv4 e IPv6 estiverem em uso, você deverá planejar os registros do host A e do AAAA.

Os tópicos listados abaixo definem o uso de registros de DNS para o planejamento de implantação:
