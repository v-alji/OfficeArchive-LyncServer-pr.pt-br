...
Após a configuração do servidor de Unificação de mensagens, você deve executar o cmdlet Enable-ExchangeCertificate para garantir que o certificado do Exchange seja aplicado ao serviço de Unificação de mensagens:
