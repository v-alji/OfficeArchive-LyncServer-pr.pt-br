...
Para obter detalhes sobre como usar o Shell de gerenciamento do Lync Server, consulte o blog do Lync Server do Windows PowerShell em [https://go.microsoft.com/fwlink/p/?linkId=203150](https://go.microsoft.com/fwlink/p/?linkid=203150) .
...
Veja a seguir uma lista dos cmdlets fornecidos com o Lync Server 2013:
  ...
  - [Parar-CsWindowsService](https://technet.microsoft.com/library/Gg398426(v=OCS.15))
  ...
  - [Cancelar publicação-CsLisConfiguration](unhttps://technet.microsoft.com/library/Gg398364(v=OCS.15))
