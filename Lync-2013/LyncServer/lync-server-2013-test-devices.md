...
---
# <a name="test-devices-in-lync-server-2013"></a>Testar dispositivos no Lync Server 2013
...
Você pode testar dispositivos na página **testar dispositivo** da seção **clientes** no painel de controle do Lync Server 2013.
