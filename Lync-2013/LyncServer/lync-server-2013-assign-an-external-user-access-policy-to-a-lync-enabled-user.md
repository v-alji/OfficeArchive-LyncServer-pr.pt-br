...
## <a name="assigning-per-user-external-access-policies-by-using-windows-powershell-cmdlets"></a>Atribuir Per-User políticas de acesso externo usando cmdlets do Windows PowerShell
