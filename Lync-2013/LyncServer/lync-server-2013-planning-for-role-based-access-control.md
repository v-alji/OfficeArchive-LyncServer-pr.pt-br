...
<td><p>CSViewOnlyAdministrator</p></td>
<td><p>View-Only o gerenciamento da organização</p></td>
</tr>
<tr class="even">
...
Os cmdlets a seguir servem como um exemplo de criação de uma nova função. Eles criam um novo tipo de função chamado `MyHelpDeskScriptRole` . A nova função tem as habilidades da função CsHelpDesk predefinida e, além disso, pode executar as funções em um script chamado "TestScript".
