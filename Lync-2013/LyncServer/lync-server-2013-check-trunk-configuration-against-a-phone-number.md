...
Executar o Test-CsTrunkConfiguration sem a primeira execução do Get-CsTrunkConfiguration não funcionará. Por exemplo, esse comando falhará sem retornar nenhum dado:
